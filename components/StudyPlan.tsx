        ...
        >
            <div className="flex items-center justify-between mb-3">
                <h2
                    ...
                    style={{ color: "rgba(219,231,255,.85)" }}
                >
                    Study Plan
                </h2>
            ...
            >
                {loading ? (
                    ...
                    <ReactMarkdown
                        ...
                        components={{
                            h1: ({node, ...props}) => <h3 className="text-lg font-semibold mb-2" {...props} />,
                            h2: ({node, ...props}) => <h4 className="text-base font-semibold mt-3 mb-1" {...props} />,
                            p:  ({node, ...props}) => <p className="mb-2" {...props} />,
                            ul: ({node, ...props}) => <ul className="list-disc pl-5 mb-2" {...props} />,
                            ol: ({node, ...props}) => <ol className="list-decimal pl-5 mb-2" {...props} />,
                            li: ({node, ...props}) => <li className="mb-1" {...props} />,
                            a:  ({node, ...props}) => <a className="underline" style={{color: "var(--accent)"}} {...props} />,
                            code: ({node, inline, ...props}) =>
                                inline ? (
                                    <code className="px-1 py-0.5 rounded" style={{background:"rgba(255,255,255,0.06)"}} {...props} />
                                ) : (
                                    <pre className="p-3 rounded overflow-auto" style={{background:"rgba(255,255,255,0.06)"}}>
              <code {...props} />
            </pre>
                                ),
                        }}
